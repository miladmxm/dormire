...
- BUILD: `EXPOSE_TESTING_API=1 pnpm build` followed by `pnpm start`; this is the measured local production build.
...
- RUN: `BASE_URL=http://localhost:3000 pnpm test:instant` against the local production server.
